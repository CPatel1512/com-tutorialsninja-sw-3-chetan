 ...
 */
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-payment-firstname"), "Chetan");
        sendTextToElement(By.id("input-payment-lastname"), "Patel");
        sendTextToElement(By.id("input-payment-email"), "prime123@gmail.com");
        sendTextToElement(By.id("input-payment-telephone"), "01234567229");
        sendTextToElement(By.id("input-payment-address-1"), "302 sutton");
        sendTextToElement(By.id("input-payment-city"), "London");
        sendTextToElement(By.id("input-payment-postcode"), "sm11qr");
