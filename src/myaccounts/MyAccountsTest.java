 ...
 */
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.id("input-firstname"), "Chetan");//Enter First Name
        sendTextToElement(By.id("input-lastname"), "Patel");  //Enter Last Name
        //Enter Email
        String userName = "ChetanPatel" + (int) (Math.random() * Integer.MAX_VALUE);  //Create random username
        String emailID = "Chetan" + userName + "@prime123@gmail.com";
        sendTextToElement(By.id("input-email"), emailID);
        sendTextToElement(By.id("input-telephone"), "07836345768"); //Enter Telephone
        sendTextToElement(By.id("input-password"), "abc12345"); //Enter Password
        sendTextToElement(By.id("input-confirm"), "abc12345");//Enter Password Confirm
